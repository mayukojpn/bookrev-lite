        ...
        <div id="wrap-up" class="clearfix">
            ...
            <div class="review-content">
                ...
                <div class="review-body clearfix">
                        ...
                        <ul>
							<?php foreach (book_rev_lite_wpr_get_review_options() as $option) : ?>
								<?php if(!empty($option['grade'])): ?>
		                            <li class="clearfix">
		                                <span class="grade"><?php echo $option['grade']; ?>/10</span>
		                                <div class="grade-bar">
                    ...
                    <div class="proscons">
                        <div class="pros">
                            <h2><?php echo book_rev_litepos("book_rev_litepos_pros_text"); ?></h2>
                            <ul>
                        ...
                        <div class="cons">
                            <h2><?php echo book_rev_litepos("book_rev_litepos_cons_text"); ?></h2>
                            <ul>
