<?php
    ...
    $default_fields = array(
        'author' => '<input name="author" type="text" placeholder="'.__("Name", "book_rev_lite").'" aria-required="true" value='. esc_attr( $commenter['comment_author'] ) .'>',
        'email'  => '<input name="email" type="text" placeholder="'.__("Email", "book_rev_lite").'" aria-required="true" value='. esc_attr( $commenter['comment_author_email'] ) .'>',
        'url'    => '<input name="url" type="text" placeholder="'.__("Website", "book_rev_lite").'" value='. esc_attr( $commenter['comment_author_website'] ) .'>',
     );

    $default_args = array(
        'fields' => $default_fields,
        'comment_field' => "<textarea id='comment-content' name='comment' aria-required='true' placeholder='" . __("Your Message...", "book_rev_lite") . "'></textarea>"
    );
